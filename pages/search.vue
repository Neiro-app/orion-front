      ...
      <div class="search__header">
        ...
        <div class="search__step" >
          <div class="search__step--white">
            ...
            <p class="search__step-subtitle" v-html="products[counter].subtitle"></p>
            <div class="search__step-counter">{{counter + 1}}/{{ products.length }}</div>
            <svg class="search__line" ref="step" xmlns="http://www.w3.org/2000/svg" width="146" height="72" viewBox="0 0 146 72" fill="none">
              <path d="M17.6772 70.4943C33.5174 -12.3518 100.819 -3.38786 107.351 18.8934C110.706 30.3346 105.011 40.7263 96.1155 38.436C79.7224 34.2154 97.4796 8.78016 114.863 3.75692C136.018 -2.35612 146.631 7.03308 143.773 23.3431M17.6772 70.4943L41.978 54.0797M17.6772 70.4943L1.14629 46.2636" stroke="black" stroke-width="2"/>
            </svg>
          </div>
...
onMounted(() => {
  tl
    .from('.search__title span', { opacity: 0, translateY: 50, delay: 1 })
    .fromTo('.search__step--white', { opacity: 0 }, { rotation: '10deg', opacity: 1})
    .to('.search__step--blue', { rotation: '-10deg', left: -25, opacity: 1, 
      onStart: function() {
